...
public class SwaggerConfig {
    ...
    private static final String API_DESCRIPTION = "Organiza";
    private static final String API_BASE_PACKAGE = "com.example.organiza.controller";
